...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    {
      url: "https://lawassistant.ai/platform/overview",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: "https://lawassistant.ai/platform/how-it-works",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: "https://lawassistant.ai/platform/why-codex",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: "https://lawassistant.ai/platform/integrations",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: "https://lawassistant.ai/use-cases/contracts",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://lawassistant.ai/use-cases/environmental",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://lawassistant.ai/use-cases/financial",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://lawassistant.ai/use-cases/hr-policy",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://lawassistant.ai/use-cases/real-estate",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: "https://lawassistant.ai/use-cases/software",
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
